...
export default function AccessConfigurationSelector({
  pageDefinitions,
  roleDefinitions,
  selectedPage,
  selectedRole,
            ...
            <Tabs
              ...
              sx={{
                ...
                '& .MuiTabs-flexContainer': {
                  gap: { xs: '10px !important', sm: '14px !important' },
                  px: 0.5,
                  py: 0.5
                },
                '& .MuiTab-root': {
                  mr: { xs: '10px !important', sm: '14px !important' },
                  '&:last-of-type': { mr: '0 !important' }
                },
                '& .MuiTabs-scroller': {
