...
import UserTabsConfigSection from './UserTabsConfigSection.jsx';
...
export default function ActivePrivilegesCard({
  selectedPageData,
  selectedRoleData,
  currentPermissions,
  selectedPage,
  ...
  return (
    ...
    >
        ...
        {PERMISSION_CARDS.map((item) => {
          ...
          return (
            ...
            >
              ...
              >
                {isActive && <CheckIcon sx={{ fontSize: { xs: 11, sm: 13 }, fontWeight: 800 }} />}
              </Box>
              ...
              >
                {React.cloneElement(item.icon, { sx: { fontSize: { xs: 18, sm: 24 } } })}
              </Box>
              ...
              <Typography
                ...
                sx={{
                  ...
                  color: isActive ? item.themeColor : '#0F172A',
                  mb: 0.3
                }}
              >
                {(() => {
      ...
      {selectedPage === 'users' && <UserTabsConfigSection {...userTabsSectionProps} />}
    </Card>
  );
}
